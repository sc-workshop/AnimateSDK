...
namespace FCM {
     ...
     */
    ConstFCMIID FCMIID_IFCMCallback = {0xdb438eab, 0xf457, 0x491d, {0x8e, 0xf2, 0xa1, 0xb8, 0x67, 0x70, 0x7e, 0x3e}};
}
...
namespace FCM {
     ...
     */
    class IFCMCallback : public FCM::VirtualClass<FCMIID_IFCMCallback> {
    public:
        /**
         ...
         */
        virtual FCM::Result _FCMCALL CreateInstance(IFCMUnknown* pUnkOuter, ConstRefFCMCLSID classID, ConstRefFCMIID interfaceID, PPVoid ppvObj) = 0;
