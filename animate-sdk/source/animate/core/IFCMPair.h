...
namespace FCM {
     ...
     */
    ConstFCMIID FCMIID_IFCMPair = {0xc80393e, 0x2037, 0x4cc3, {0xbf, 0x69, 0x1c, 0xee, 0x81, 0x75, 0xe1, 0x6d}};
}
...
namespace FCM {
    ...
    public:
        virtual FCM::Result _FCMCALL SetValue(FCM::U_Int32 index, FCMPairTypeID type, FCM::PVoid value, FCM::U_Int32 valueLen) = 0;

        virtual FCM::Result _FCMCALL GetInfo(FCM::U_Int32 index, FCMPairTypeID& type, FCM::U_Int32& valueLen) = 0;

        virtual FCM::Result _FCMCALL GetValue(FCM::U_Int32 index, FCMPairTypeID type, FCM::PVoid value, FCM::U_Int32 valueLen) = 0;

        virtual FCM::Result _FCMCALL Remove(FCM::U_Int32 index) = 0;
