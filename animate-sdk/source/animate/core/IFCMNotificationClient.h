...
namespace FCM {
     ...
     */
    ConstFCMIID FCMIID_IFCMNotificationClient = {0x44ba2ffc, 0x2057, 0x4c95, {0xaa, 0x38, 0x80, 0xd6, 0xea, 0x0, 0x73, 0x36}};
}
...
namespace FCM {
     ...
     */
    class IFCMNotificationClient : public FCM::VirtualClass<FCMIID_IFCMNotificationClient> {
    public:
        /**
         ...
         */
        virtual FCM::Result _FCMCALL Notify(ConstRefFCMNotifyID nid, FCM::PVoid pNotificationData, FCM::PVoid pRefCon) = 0;
    };
