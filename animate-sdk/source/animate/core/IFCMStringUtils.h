...
namespace FCM {
     ...
     */
    ConstFCMIID FCMIID_IFCMStringUtils = {0x974efcc9, 0xb1e4, 0x4bfa, {0x8e, 0xa3, 0xb9, 0xc4, 0x1f, 0x2a, 0x45, 0xf}};
}
...
namespace FCM {
     ...
     */
    class IFCMStringUtils : public FCM::VirtualClass<FCMIID_IFCMStringUtils> {
    public:
        /**
