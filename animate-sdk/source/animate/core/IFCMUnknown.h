...
namespace FCM {
     ...
     */
    ConstFCMIID ID_IFCMUnknown = {0x775c253a, 0x376d, 0x4069, {0x83, 0x36, 0xc5, 0x1a, 0xfd, 0x11, 0x16, 0x3f}};
}
...
namespace FCM {
    ...
    class IFCMUnknown {
    public:
        inline static FCMIID GetIID() { return ID_IFCMUnknown; };
    ...
    public:
         ...
         */
        virtual FCM::Result _FCMCALL QueryInterface(ConstRefFCMIID pInterfaceID, PPVoid ppvObj) = 0;
