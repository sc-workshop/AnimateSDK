...
namespace FCM {
     ...
     */
    ConstFCMIID FCMIID_IFCMNoAggregationUnknown = {0xf04d68cf, 0x9429, 0x4393, {0x98, 0xa, 0xa2, 0x21, 0x5f, 0x5, 0xa, 0x17}};
}
...
namespace FCM {
    ...
    class IFCMNoAggregationUnknown {
    public:
        inline static FCM::FCMIID GetIID() { return FCMIID_IFCMNoAggregationUnknown; };
