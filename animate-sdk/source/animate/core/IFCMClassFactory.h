...
namespace FCM {
     ...
     */
    ConstFCMIID ID_IFCMClassFactory = {0xb249192e, 0xd262, 0x43ba, {0x86, 0x52, 0xc4, 0x1f, 0xcb, 0x34, 0x20, 0xf5}};
}
...
namespace FCM {
    ...
    public:
         ...
         */
        virtual FCM::Result _FCMCALL CreateInstance(PIFCMUnknown pUnkOuter, PIFCMCallback pCallback, ConstRefFCMIID iid, PPVoid pAny) = 0;
    };
} // namespace FCM
