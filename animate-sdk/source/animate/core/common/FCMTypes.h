...
namespace FCM {
    ...
    struct FCMGUID {
        ...
        operator std::string() const {
            ...
            std::transform(guid_str.begin(), guid_str.end(), guid_str.begin(), [](const char val) { return (char) std::toupper(val); });
    ...
    __inline bool operator==(const FCMGUID& guidOne, const FCMGUID& guidOther) {
        return ((guidOne.Data1 == guidOther.Data1) && (guidOne.Data2 == guidOther.Data2) && (guidOne.Data3 == guidOther.Data3) &&
                (*(U_Int32*) guidOne.Data4 == *(U_Int32*) guidOther.Data4) && (*(U_Int32*) (guidOne.Data4 + 4) == *((U_Int32*) (guidOther.Data4 + 4))));
    }
