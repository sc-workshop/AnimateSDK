...
namespace FCM {
     ...
     */
    constexpr FCM::U_Int8 FCM_VERSION_MAJOR = 0x01;
     ...
     */
    constexpr FCM::U_Int8 FCM_VERSION_MINOR = 0x03;
     ...
     */
    constexpr FCM::U_Int8 FCM_VERSION_MAINTENANCE = 0x00;
     ...
     */
    constexpr FCM::U_Int8 FCM_VERSION_BUILD = 0x00;
     ...
     */
#define FCM_VERSION ((FCM_VERSION_MAJOR << 24) | (FCM_VERSION_MINOR << 16) | (FCM_VERSION_MAINTENANCE << 8) | (FCM_VERSION_BUILD))
     ...
     */
#define DEFINE_FCMIID (name, l, w1, w2, b1, b2, b3, b4, b5, b6, b7, b8) const FCMID name = {l, w1, w2, {b1, b2, b3, b4, b5, b6, b7, b8}}
...
#define IID(ifx) ID_##ifx
     ...
     */
#define _FCM_SIMPLEMAPENTRY ((FCM::_FCM_CREATORARGFUNC*) 0)
...
#define FCM_RELEASE(intPtr)                                                                                                                                    \
     ...
     */
    constexpr FCM::U_Int8 _FCM_PACKING = 1;
     ...
     */
#define offsetofclass(base, derived) ((FCM::S_Int64)(static_cast<base*>((derived*) FCM::_FCM_PACKING)) - FCM::_FCM_PACKING)
     ...
     */
#define offsetofclasscustom(base, custom, derived) ((FCM::S_Int64)(static_cast<base*>((custom*) ((derived*) FCM::_FCM_PACKING))) - FCM::_FCM_PACKING)
...
public:                                                                                                                                                        \
    ...
    static FCM::FCMInterfaceMap* GetInterfaceMap() {                                                                                                           \
        static FCM::FCMInterfaceMap _pInterfaceMap[] = { INTERFACE_ENTRY(IFCMUnknown)
 ...
 */
#define BEGIN_MODULE(usrModule) class usrModule : public FCM::PluginModule {
/**
...
public:                                                                                                                                                        \
    Result Init(FCM::PIFCMCallback pCallback) {                                                                                                                \
        Result res = PluginModule::Init(pCallback);
 ...
 */
#define CLASS_ENTRY(clsid, ursClass) AddClassEntry(clsid, &FCM::FCMClassFactory<ursClass>::GetFactory, &ursClass::GetInterfaceMap, ursClass::GetVersion());
