...
namespace Animate::DocType {
    ...
    public:
        virtual FCM::Result _FCMCALL GetFeatureMatrix(PIFeatureMatrix& featureMatrix) {
            ...
            if (m_features.m_Ptr == nullptr) {
                res = GetCallback()->CreateInstance(NULL,
    ...
    inline FCM::Result RegisterDocument(FCM::PIFCMDictionary plugins, FCM::ConstFCMCLSID docTypeID, const ModuleInfo& module_info) {
        FCM::Result res = FCM_SUCCESS;
...

        {
            ...
            res = plugins->AddLevel((const FCM::StringRep8)(((std::string) docTypeID).c_str()), plugin.m_Ptr);

            {
...

                {
                    ...
                    res = category->Add((const FCM::StringRep8) Application::kApplicationCategoryKey_Name,
                    ...
                    res = category->Add((const FCM::StringRep8) Application::kApplicationCategoryKey_UniversalName,
                                        FCMDictRecTypeID::StringRep8,
                    ...
                    res = category->Add((const FCM::StringRep8) Application::kApplicationDocTypeKey_Desc,
                                        FCMDictRecTypeID::StringRep8,
