...
namespace Animate::DocType {
    ...
    public:
        virtual FCM::Result _FCMCALL IsSupported(FCM::CStringRep16 featureName, FCM::Boolean& isSupported);

        virtual FCM::Result _FCMCALL IsSupported(FCM::CStringRep16 featureName, FCM::CStringRep16 propertyName, FCM::Boolean& isSupported);

        virtual FCM::Result _FCMCALL IsSupported(FCM::CStringRep16 featureName,
                                                 FCM::CStringRep16 propertyName,
                                                 FCM::CStringRep16 valueName,
                                                 FCM::Boolean& isSupported);

        virtual FCM::Result _FCMCALL GetDefaultValue(FCM::CStringRep16 featureName, FCM::CStringRep16 propertyName, FCM::VARIANT& output);
