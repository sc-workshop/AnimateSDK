...
namespace Animate::DocType {
    FCM::Result _FCMCALL GenericFeatureMatrix::IsSupported(FCM::CStringRep16 featureName, FCM::Boolean& isSupported) {
    ...
    FCM::Result _FCMCALL GenericFeatureMatrix::IsSupported(FCM::CStringRep16 featureName, FCM::CStringRep16 propertyName, FCM::Boolean& isSupported) {
        if (!ANIMATE_SDK_USE_FEATURE_MATRIX) {
            isSupported = true;
            return FCM_SUCCESS;
        }
    ...
    FCM::Result _FCMCALL GenericFeatureMatrix::IsSupported(FCM::CStringRep16 featureName,
    ...
    FCM::Result _FCMCALL GenericFeatureMatrix::GetDefaultValue(FCM::CStringRep16 featureName, FCM::CStringRep16 propertyName, FCM::VARIANT& output) {
