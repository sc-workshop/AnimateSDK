    ...
    bool FilledElementPathSegment::operator==(const FilledElementPathSegment& other) const {
        ...
        switch (SegmentType()) {
            case Type::Line: {
                ...
                if (current_segment.begin != other_segment.begin)
                    return false;
                if (current_segment.end != other_segment.end)
                    return false;
            ...
            case Type::Cubic: {
                ...
                if (current_segment.end != other_segment.end)
                    return false;
                if (current_segment.control_l != other_segment.control_l)
                    return false;
                if (current_segment.control_r != other_segment.control_r)
                    return false;
            ...
            case Type::Quad: {
                ...
                if (current_segment.end != other_segment.end)
                    return false;
                if (current_segment.control != other_segment.control)
                    return false;
