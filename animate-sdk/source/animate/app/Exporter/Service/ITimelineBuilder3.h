...
/* -------------------------------------------------- Macros / Constants */
namespace Animate::Exporter::Service {
    /**
     ...
     */
    FCM::ConstFCMIID IID_ITIMELINE_BUILDER_3 = {0xf1478d8d, 0x9046, 0x41b9, {0x91, 0x2f, 0x67, 0x9e, 0x52, 0xfd, 0xd, 0x24}};
}
...
namespace Animate::Exporter::Service {
     ...
     */
    class ITimelineBuilder3 : public FCM::ChildrenVirtualClass<IID_ITIMELINE_BUILDER_3, ITimelineBuilder2> {
    public:
        /**
         ...
         *
         * @param matrix (IN)
         *        A 3D matrix that defines the transform to be applied to the object. This matrix contains Z-depth
         * information
         *
         * @return On success, FCM_SUCCESS is returned, else an error code is returned.
         */
        virtual FCM::Result _FCMCALL Update3dDisplayTransform(FCM::U_Int32 objectId, const DOM::Utils::MATRIX3D& matrix) = 0;
    };
}
