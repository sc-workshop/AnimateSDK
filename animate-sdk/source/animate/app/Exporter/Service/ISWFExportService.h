...
namespace Animate::Exporter::Service {
     ...
     */
    FCM::ConstFCMIID IID_ISWF_EXPORT_SERVICE = {0xb4c11f4f, 0x982a, 0x4d24, {0xa5, 0xc4, 0xbf, 0x9c, 0xa0, 0x43, 0x7b, 0xf5}};
}
...
namespace Animate::Exporter::Service {
     ...
     */
    class ISWFExportService : public FCM::VirtualClass<IID_ISWF_EXPORT_SERVICE> {
    public:
        /**
         ...
         */
        virtual FCM::Result _FCMCALL ExportToFile(DOM::PIFLADocument pFlaDocument, FCM::CStringRep16 pFilePath) = 0;
         ...
         *         "com.adobe.events.flash.extension.savestate" event.
         */
        virtual FCM::Result _FCMCALL ExportToFile(DOM::PITimeline pTimeline, FCM::CStringRep16 pFilePath) = 0;
    };
}
