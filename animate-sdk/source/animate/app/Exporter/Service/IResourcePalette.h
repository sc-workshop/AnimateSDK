...
namespace Animate::Exporter::Service {
     ...
     */
    FCM::ConstFCMIID IID_IRESOURCE_PALETTE = {0xbc49188c, 0xb9f7, 0x4bca, {0xaa, 0x58, 0xed, 0x3c, 0xd9, 0xbc, 0xfc, 0xc7}};
}
...
namespace Animate::Exporter::Service {
     ...
     */
    class IResourcePalette : public FCM::VirtualClass<IID_IRESOURCE_PALETTE> {
    public:
        /**
