...
namespace Animate::Exporter::Service {
     ...
     */
    FCM::ConstFCMIID IID_ITIMELINE_BUILDER = {0xe1fa4e28, 0x3a46, 0x4106, {0xbc, 0xdb, 0xf, 0x46, 0x5b, 0x1f, 0xd4, 0x62}};
}
...
namespace Animate::Exporter::Service {
     ...
     */
    class ITimelineBuilder : public FCM::VirtualClass<IID_ITIMELINE_BUILDER> {
    public:
        /**
         ...
         * @return On success, FCM_SUCCESS is returned, else an error code is returned.
         */
        virtual FCM::Result _FCMCALL UpdateBlendMode(FCM::U_Int32 objectId, FCM::BlendMode blendMode) = 0;
         ...
         * @return On success, FCM_SUCCESS is returned, else an error code is returned.
         */
        virtual FCM::Result _FCMCALL UpdateGraphicFilter(FCM::U_Int32 objectId, FCM::PIFCMList pFilterable) = 0;
