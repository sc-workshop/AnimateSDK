...
namespace Animate::Exporter::Service {
     ...
     */
    FCM::ConstFCMIID IID_IFRAME_COMMAND_GENERATOR = {0x440d57c4, 0xe12c, 0x4aae, {0x9a, 0x68, 0xd3, 0x61, 0x11, 0x91, 0xfa, 0x3e}};
}
...
namespace Animate::Exporter::Service {
    ...
    public:
         ...
         */
        virtual FCM::Result _FCMCALL GenerateFrameCommands(DOM::PITimeline pTimeline,
