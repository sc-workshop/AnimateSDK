...
namespace Animate {
    ...
    namespace DocType {
         ...
         */
        FCM::ConstFCMIID ID_IFeatureMatrix = {0x745f0985, 0x43a9, 0x4f11, {0xbb, 0x66, 0x60, 0x21, 0xd5, 0x22, 0x23, 0xd7}};
    }
    ...
    namespace DocType {
        ...
        class IFeatureMatrix : public FCM::VirtualClass<ID_IFeatureMatrix> {
             ...
             *         "ClassicTween".
             */
            virtual FCM::Result _FCMCALL IsSupported(FCM::CStringRep16 inFeatureName, FCM::Boolean& isSupported) = 0;
             ...
             *        <"ClassicTween", "Scale">
             */
            virtual FCM::Result _FCMCALL IsSupported(FCM::CStringRep16 inFeatureName, FCM::CStringRep16 inPropName, FCM::Boolean& isSupported) = 0;
             ...
             */
            virtual FCM::Result _FCMCALL IsSupported(FCM::CStringRep16 inFeatureName,
             ...
             * @return On success, FCM_SUCCESS is returned, else an error code is returned.
             */
            virtual FCM::Result _FCMCALL GetDefaultValue(FCM::CStringRep16 inFeatureName, FCM::CStringRep16 inPropName, FCM::VARIANT& outDefVal) = 0;
        };
    }
}
