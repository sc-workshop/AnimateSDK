...
namespace Animate {
    ...
    namespace DOM::Service::Media3D {
         ...
         */
        FCM::ConstFCMIID IID_IMedia3D_EXPORT_SERVICE = {0xe9f0b6db, 0x9611, 0x4bd8, {0xa4, 0xad, 0x2c, 0x6e, 0xae, 0x7b, 0x24, 0x2b}};
    }
    ...
    namespace DOM::Service::Media3D {
        ...
        public:
             ...
             */
            virtual FCM::Result _FCMCALL CopyFilesTo(const DOM::IFLADocument* pFlaDocument, const FCM::CStringRep16 libPath, FCM::CStringRep16 destPath) = 0;
        };
    }
}
