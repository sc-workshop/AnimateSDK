...
namespace Animate {
    ...
    namespace DOM::Service::Shape {
         ...
         */
        FCM::ConstFCMIID IID_IREGION_GENERATOR_SERVICE = {0xec97bc1d, 0xc7f, 0x419e, {0x83, 0x6c, 0x69, 0x97, 0x52, 0x96, 0x71, 0xa9}};
    }
    ...
    namespace DOM::Service::Shape {
        ...
        public:
             ...
             */
            virtual FCM::Result _FCMCALL GetFilledRegions(DOM::FrameElement::PIShape pShape, FCM::PIFCMList& pFilledRegionList) = 0;
             ...
             */
            virtual FCM::Result _FCMCALL GetStrokeGroups(DOM::FrameElement::PIShape pShape, FCM::PIFCMList& pStrokeGroupList) = 0;
        };
    }
}
