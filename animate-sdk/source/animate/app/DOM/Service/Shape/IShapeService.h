...
namespace Animate {
    ...
    namespace DOM::Service::Shape {
         ...
         */
        FCM::ConstFCMIID IID_ISHAPE_SERVICE = {0x8365e61d, 0x558d, 0x4540, {0xa7, 0xa4, 0xf4, 0xf9, 0x8e, 0x6a, 0xf0, 0x9b}};
    }
    ...
    namespace DOM::Service::Shape {
         ...
         */
        class IShapeService : public FCM::VirtualClass<IID_ISHAPE_SERVICE> {
        public:
            /**
             ...
             */
            virtual FCM::Result _FCMCALL ConvertStrokeToFill(DOM::FrameElement::PIShape pSrcShape, DOM::FrameElement::PIShape& pDstShape) = 0;
             ...
             */
            virtual FCM::Result _FCMCALL TestShapeSimilarity(DOM::FrameElement::PIShape pShapeA,
