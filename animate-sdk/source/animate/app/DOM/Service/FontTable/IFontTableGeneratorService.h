...
namespace Animate {
    ...
    namespace DOM::Service::FontTable {
         ...
         */
        FCM::ConstFCMIID IID_IFONT_TABLE_GENERATOR_SERVICE = {0xdfa12563, 0x76b3, 0x4f88, {0x9e, 0x4, 0xfd, 0x15, 0xc, 0xb6, 0x39, 0x68}};
    }
    ...
    namespace DOM::Service::FontTable {
        ...
        public:
             ...
             */
            virtual FCM::Result _FCMCALL CreateFontTable(const PIFLADocument& pFlaDoc,
             ...
             * @return On success, FCM_SUCCESS is returned, else an error code is returned.
             */
            virtual FCM::Result _FCMCALL CreateFontTableForFontItem(const LibraryItem::PIFontItem& pFontItem, PIFontTable& pFontTable) = 0;
        };
    }
}
