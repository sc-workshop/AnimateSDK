...
namespace Animate {
    ...
    namespace DOM::Service::FontTable {
         ...
         */
        FCM::ConstFCMIID IID_IFONT_TABLE = {0x88871ced, 0xe055, 0x4502, {0xbb, 0xfd, 0x28, 0x78, 0x4a, 0x54, 0xff, 0xd8}};
    }
    ...
    namespace DOM::Service::FontTable {
         ...
         */
        class IFontTable : public FCM::VirtualClass<IID_IFONT_TABLE> {
        public:
            /**
             ...
             */
            virtual FCM::Result _FCMCALL GetCopyrightInfo(FCM::StringRep16& ppCopyrightInfo) = 0;
             ...
             * @see    IGlyph
             */
            virtual FCM::Result _FCMCALL GetGlyphs(FrameElement::OrientationMode orientationMode, FCM::PIFCMList& pGlyphList) = 0;
             ...
             *
             */
            virtual FCM::Result _FCMCALL GetAscent(FrameElement::OrientationMode orientationMode, FCM::Double& ascent) = 0;
             ...
             *
             */
            virtual FCM::Result _FCMCALL GetDescent(FrameElement::OrientationMode orientationMode, FCM::Double& descent) = 0;
             ...
             * @see    IGlyph
             */
            virtual FCM::Result _FCMCALL GetKerningPairs(FrameElement::OrientationMode orientationMode, FCM::PIFCMList& pKerningPairList) = 0;
        };
    }
}
