...
namespace Animate {
    ...
    namespace DOM::Service::Sound {
         ...
         */
        FCM::ConstFCMIID IID_ISOUND_EXPORT_SERVICE = {0xdead57ce, 0xc4dc, 0x44d2, {0xb1, 0x40, 0xe8, 0x23, 0x74, 0x27, 0x2c, 0xf5}};
    }
    ...
    namespace DOM::Service::Sound {
        ...
        public:
             ...
             */
            virtual FCM::Result _FCMCALL ExportToFile(const LibraryItem::PIMediaItem pSound, FCM::CStringRep16 pFilePath) = 0;
        };
    }
}
