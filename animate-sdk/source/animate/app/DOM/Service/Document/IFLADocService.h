...
namespace Animate {
    ...
    namespace DOM::Service::Document {
         ...
         */
        FCM::ConstFCMIID IID_IFLA_DOC_SERVICE = {0xb4a3cdfe, 0xfaab, 0x4566, {0x80, 0x45, 0x5b, 0x84, 0x47, 0xe9, 0xa2, 0x3b}};
    }
    ...
    namespace DOM::Service::Document {
        ...
        public:
             ...
             */
            virtual FCM::Result _FCMCALL OpenDocument(FCM::CStringRep16 pFullPath, PIFLADocument& pOutDocument) = 0;
