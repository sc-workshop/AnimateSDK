...
namespace Animate {
    ...
    namespace DOM::Service::Tween {
         ...
         */
        FCM::ConstFCMIID IID_ISHAPE_TWEENER = {0x7228a823, 0x6a82, 0x4c89, {0xa6, 0xc, 0x7c, 0xb8, 0xc2, 0x18, 0x3e, 0xe4}};
    }
    ...
    namespace DOM::Service::Tween {
        ...
        public:
             ...
             */
            virtual FCM::Result _FCMCALL GetShape(PITween pTween, FCM::U_Int32 offset, DOM::FrameElement::PIShape& pShape) = 0;
        };
    }
}
