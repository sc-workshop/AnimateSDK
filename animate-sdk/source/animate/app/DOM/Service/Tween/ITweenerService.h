...
namespace Animate {
    ...
    namespace DOM::Service::Tween {
         ...
         */
        FCM::ConstFCMIID IID_ITWEENER_SERVICE = {0xdb5ed0c2, 0x1d0, 0x4da0, {0x90, 0x7c, 0x99, 0x96, 0x33, 0x43, 0x13, 0x8a}};
    }
    ...
    namespace DOM::Service::Tween {
        ...
        public:
             ...
             */
            virtual FCM::Result _FCMCALL GetTweener(const FCM::FCMGUID& propId, void* reserved, FCM::PIFCMUnknown& pTweener) = 0;
        };
    }
}
