...
namespace Animate {
    ...
    namespace DOM::Service::Tween {
         ...
         */
        FCM::ConstFCMIID IID_ITWEEN_INFO_SERVICE = {0x44bf6a6f, 0x9b5b, 0x438d, {0x85, 0x94, 0xbb, 0x10, 0x89, 0x72, 0x31, 0x75}};
    }
    ...
    namespace DOM::Service::Tween {
        ...
        public:
             ...
             *
             */
            virtual FCM::Result _FCMCALL GetElementTweenInfo(FCM::PIFCMCallback pCallback,
                                                             DOM::FrameElement::PIFrameDisplayElement pElement,
                                                             FCM::PIFCMList& pTweenInfoList) = 0;
