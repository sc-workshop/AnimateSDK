...
namespace Animate {
    ...
    namespace DOM::Service::Tween {
         ...
         */
        FCM::ConstFCMIID IID_ICOLOR_TWEENER = {0xba44c10e, 0x6eaa, 0x4aee, {0xa9, 0xe9, 0xf1, 0x4e, 0x9b, 0xf8, 0x33, 0x21}};
    }
    ...
    namespace DOM::Service::Tween {
         ...
         */
        class IColorTweener : public FCM::VirtualClass<IID_ICOLOR_TWEENER> {
        public:
            /**
             ...
             */
            virtual FCM::Result _FCMCALL GetColorMatrix(PITween pTween, FCM::U_Int32 offset, Utils::COLOR_MATRIX& colorMatrix) = 0;
        };
    }
}
