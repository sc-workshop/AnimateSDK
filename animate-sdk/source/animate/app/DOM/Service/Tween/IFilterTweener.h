...
namespace Animate {
    ...
    namespace DOM::Service::Tween {
         ...
         */
        FCM::ConstFCMIID IID_IFILTER_TWEENER = {0x2b1cb09e, 0xf507, 0x4bd2, {0xa1, 0xef, 0x1a, 0x61, 0xe5, 0x83, 0x60, 0x8f}};
    }
    ...
    namespace DOM::Service::Tween {
        ...
        public:
             ...
             *         returned.
             */
            virtual FCM::Result _FCMCALL GetFilters(PITween pTween, FCM::U_Int32 offset, FCM::PIFCMList& pFilterList) = 0;
        };
    }
}
