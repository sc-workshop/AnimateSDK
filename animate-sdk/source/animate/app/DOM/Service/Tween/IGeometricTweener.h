...
namespace Animate {
    ...
    namespace DOM::Service::Tween {
         ...
         */
        FCM::ConstFCMIID IID_IGEOMETRIC_TWEENER = {0x3d45198b, 0x1ecd, 0x4731, {0xa7, 0x1c, 0xa8, 0xc4, 0x89, 0x7f, 0x1b, 0x1c}};
    }
    ...
    namespace DOM::Service::Tween {
         ...
         */
        class IGeometricTweener : public FCM::VirtualClass<IID_IGEOMETRIC_TWEENER> {
        public:
            /**
             ...
             */
            virtual FCM::Result _FCMCALL GetGeometricTransform(PITween pTween, FCM::U_Int32 offset, Utils::MATRIX2D& geomMatrix) = 0;
        };
    }
}
