...
namespace Animate {
    ...
    namespace DOM::Service::Image {
         ...
         */
        FCM::ConstFCMIID IID_IBITMAP_EXPORT_SERVICE = {0xb795a4b4, 0x4a08, 0x4de0, {0x9d, 0xfa, 0x5b, 0xe, 0x81, 0x98, 0x6, 0x5f}};
    }
    ...
    namespace DOM::Service::Image {
         ...
         *        file formats.
         */
        class IBitmapExportService : public FCM::VirtualClass<IID_IBITMAP_EXPORT_SERVICE> {
        public:
            /**
             ...
             */
            virtual FCM::Result _FCMCALL ExportToFile(const LibraryItem::PIMediaItem pBitmap, FCM::CStringRep16 pFilePath, FCM::U_Int32 quality) = 0;
        };
    }
}
