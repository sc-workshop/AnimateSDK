...
namespace Animate {
    ...
    namespace DOM::Service::TextLayout {
         ...
         */
        FCM::ConstFCMIID IID_ITEXT_LINES_GENERATOR_SERVICE = {0x30d8005f, 0x7046, 0x4e66, {0xa4, 0x37, 0x4f, 0xcd, 0x6a, 0x78, 0xde, 0xd5}};
    }
    ...
    namespace DOM::Service::TextLayout {
        ...
        public:
             ...
             */
            virtual FCM::Result _FCMCALL GetTextLines(const FrameElement::PIClassicText& pClassicText, FCM::PIFCMList& pTextLineList) = 0;
        };
    }
}
