...
namespace Animate {
    ...
    namespace DOM::LibraryItem {
         ...
         */
        FCM::ConstFCMIID IID_IFONT_ITEM = {0x731bcb32, 0x50db, 0x4a6c, {0x97, 0x50, 0x9e, 0x6c, 0xef, 0x8d, 0xf1, 0xaf}};
    }
    ...
    namespace DOM::LibraryItem {
         ...
         */
        class IFontItem : public FCM::VirtualClass<IID_IFONT_ITEM> {
        public:
            /**
             * @brief  This function determines the name of the device font that should be associated with this Font
             * Item.
             *
             ...
             */
            virtual FCM::Result _FCMCALL GetEmbeddedCharacters(FCM::StringRep16& ppEmbeddedCharacters) = 0;
