...
namespace Animate {
    ...
    namespace DOM::Utils {
         ...
         */
        FCM::ConstFCMIID IID_ISOUND_EFFECT = {0xddf122a4, 0xf880, 0x4444, {0x93, 0xbf, 0x4e, 0x5b, 0x23, 0x6a, 0xc9, 0xa}};
    }
    ...
    namespace DOM::Utils {
         ...
         */
        class ISoundEffect : public FCM::VirtualClass<IID_ISOUND_EFFECT> {
        public:
            /**
