...
namespace Animate {
    ...
    namespace DOM::Utils {
         ...
         */
        FCM::ConstFCMIID IID_ILINEAR_COLOR_GRADIENT = {0x39ce80b7, 0x90a9, 0x479e, {0xa4, 0x6c, 0xd4, 0x8f, 0xa6, 0xcf, 0xc9, 0x23}};
    }
    ...
    namespace DOM::Utils {
         ...
         */
        class ILinearColorGradient : public FCM::VirtualClass<IID_ILINEAR_COLOR_GRADIENT> {
        public:
            /**
