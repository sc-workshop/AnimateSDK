...
namespace Animate {
    ...
    namespace DOM::Utils {
         ...
         */
        FCM::ConstFCMIID IID_IRADIAL_COLOR_GRADIENT = {0x28dc1e66, 0x66f, 0x4aba, {0x92, 0xa0, 0xaa, 0x9d, 0xb7, 0x4b, 0x98, 0x53}};
    }
    ...
    namespace DOM::Utils {
         ...
         */
        class IRadialColorGradient : public FCM::VirtualClass<IID_IRADIAL_COLOR_GRADIENT> {
        public:
            /**
