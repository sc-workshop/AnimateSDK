...
namespace Animate {
    ...
    namespace DOM::GraphicFilter {
         ...
         */
        FCM::ConstFCMIID IID_IADJUST_COLOR_FILTER = {0x4398cc6b, 0xe5df, 0x4b97, {0x91, 0x8d, 0xf8, 0xee, 0x93, 0x76, 0x85, 0xa5}};
    }
    ...
    namespace DOM::GraphicFilter {
         ...
         */
        class IAdjustColorFilter : public FCM::VirtualClass<IID_IADJUST_COLOR_FILTER> {
        public:
            /**
