...
namespace Animate {
    ...
    namespace DOM::GraphicFilter {
         ...
         */
        FCM::ConstFCMIID IID_IDROP_SHADOW_FILTER = {0x2aef9c73, 0x153e, 0x4caf, {0x80, 0x64, 0xa8, 0x40, 0x26, 0x6e, 0x8e, 0x83}};
    }
    ...
    namespace DOM::GraphicFilter {
         ...
         */
        class IDropShadowFilter : public FCM::VirtualClass<IID_IDROP_SHADOW_FILTER> {
        public:
            /**
