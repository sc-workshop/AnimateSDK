...
namespace Animate {
    ...
    namespace DOM::GraphicFilter {
         ...
         */
        FCM::ConstFCMIID IID_IBEVEL_FILTER = {0xb6b6702d, 0xd4bd, 0x4b28, {0xb9, 0x16, 0xfa, 0x71, 0x3e, 0xe1, 0xe, 0x70}};
    }
    ...
    namespace DOM::GraphicFilter {
         ...
         */
        class IBevelFilter : public FCM::VirtualClass<IID_IBEVEL_FILTER> {
        public:
            /**
