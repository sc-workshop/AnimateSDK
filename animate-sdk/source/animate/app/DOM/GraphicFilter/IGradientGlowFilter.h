...
namespace Animate {
    ...
    namespace DOM::GraphicFilter {
         ...
         */
        FCM::ConstFCMIID IID_IGRADIENT_GLOW_FILTER = {0xab4017b5, 0x6994, 0x4d76, {0xa6, 0xd4, 0x1, 0xf1, 0x6f, 0x1d, 0x92, 0x90}};
    }
    ...
    namespace DOM::GraphicFilter {
         ...
         */
        class IGradientGlowFilter : public FCM::VirtualClass<IID_IGRADIENT_GLOW_FILTER> {
        public:
            /**
