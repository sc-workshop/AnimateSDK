...
namespace Animate {
    ...
    namespace DOM::GraphicFilter {
         ...
         */
        FCM::ConstFCMIID IID_IGRADIENT_BEVEL_FILTER = {0x9bf0d5c, 0x78ed, 0x4d0f, {0x9b, 0xf5, 0x75, 0xf8, 0x1b, 0x2d, 0xe0, 0xab}};
    }
    ...
    namespace DOM::GraphicFilter {
         ...
         */
        class IGradientBevelFilter : public FCM::VirtualClass<IID_IGRADIENT_BEVEL_FILTER> {
        public:
            /**
