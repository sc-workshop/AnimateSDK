...
namespace Animate {
    ...
    namespace DOM::GraphicFilter {
         ...
         */
        FCM::ConstFCMIID IID_IBLUR_FILTER = {0xb3c424e6, 0x9f46, 0x4fb3, {0x88, 0x9a, 0x10, 0x3a, 0xd5, 0x16, 0xda, 0x21}};
    }
    ...
    namespace DOM::GraphicFilter {
         ...
         */
        class IBlurFilter : public FCM::VirtualClass<IID_IBLUR_FILTER> {
        public:
            /**
