...
namespace Animate {
    ...
    namespace DOM::GraphicFilter {
         ...
         */
        FCM::ConstFCMIID IID_IGLOW_FILTER = {0x473cc4cd, 0xcd5b, 0x48d0, {0xb3, 0x4e, 0x59, 0x51, 0x3a, 0x70, 0x84, 0x51}};
    }
    ...
    namespace DOM::GraphicFilter {
         ...
         */
        class IGlowFilter : public FCM::VirtualClass<IID_IGLOW_FILTER> {
        public:
            /**
