...
namespace Animate {
    ...
    namespace DOM::StrokeStyle {
         ...
         */
        FCM::ConstFCMIID IID_IDASHED_STROKE_STYLE = {0xc442d351, 0xda7b, 0x4982, {0xa9, 0xda, 0xce, 0x66, 0x82, 0xea, 0xec, 0x47}};
    }
    ...
    namespace DOM::StrokeStyle {
         ...
         */
        class IDashedStrokeStyle : public FCM::VirtualClass<IID_IDASHED_STROKE_STYLE> {
        public:
            /**
