...
namespace Animate {
    ...
    namespace DOM::StrokeStyle {
         ...
         */
        FCM::ConstFCMIID IID_IHATCHED_STROKE_STYLE = {0x29964748, 0xa64a, 0x49f7, {0x97, 0xde, 0x3f, 0xc1, 0x9d, 0x5, 0x4f, 0xdd}};
    }
    ...
    namespace DOM::StrokeStyle {
        ...
        public:
             ...
             * @return On success, FCM_SUCCESS is returned, else an error code is returned.
             */
            virtual FCM::Result _FCMCALL GetHatchedThicknessType(HatchedThicknessType& thicknessType) = 0;
