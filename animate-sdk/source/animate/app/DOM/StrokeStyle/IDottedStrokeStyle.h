...
namespace Animate {
    ...
    namespace DOM::StrokeStyle {
         ...
         */
        FCM::ConstFCMIID IID_IDOTTED_STROKE_STYLE = {0xb686e0ad, 0xc9b4, 0x43dc, {0x9d, 0xd, 0x73, 0xd5, 0x6, 0xa9, 0x66, 0xe}};
    }
    ...
    namespace DOM::StrokeStyle {
         ...
         */
        class IDottedStrokeStyle : public FCM::VirtualClass<IID_IDOTTED_STROKE_STYLE> {
        public:
            /**
