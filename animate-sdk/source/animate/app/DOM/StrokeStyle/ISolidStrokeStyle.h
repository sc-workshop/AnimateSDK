...
namespace Animate {
    ...
    namespace DOM::StrokeStyle {
         ...
         */
        FCM::ConstFCMIID IID_ISOLID_STROKE_STYLE = {0x6a896201, 0xfd1d, 0x46db, {0x8a, 0xe2, 0xbe, 0x5b, 0x9a, 0xb2, 0x55, 0x29}};
    }
    ...
    namespace DOM::StrokeStyle {
         ...
         */
        class ISolidStrokeStyle : public FCM::VirtualClass<IID_ISOLID_STROKE_STYLE> {
        public:
            /**
