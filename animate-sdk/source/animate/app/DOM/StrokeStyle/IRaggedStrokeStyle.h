...
namespace Animate {
    ...
    namespace DOM::StrokeStyle {
         ...
         */
        enum class RaggedStrokePattern {
            /** Solid pattern  */
            RAGGED_SOLID_PATTERN = 0,
         ...
         */
        enum class RaggedWaveHeight {
            /** Flat  */
            RAGGED_WAVEHEIGHT_FLAT = 0,
         ...
         */
        enum class RaggedWaveLength {
            /** Very short  */
            RAGGED_WAVELENGTH_VERYSHORT = 0,
    ...
    namespace DOM::StrokeStyle {
         ...
         */
        FCM::ConstFCMIID IID_IRAGGED_STROKE_STYLE = {0xfcaa3162, 0x1c2d, 0x4c2b, {0x91, 0xca, 0x6f, 0x64, 0xc3, 0x9d, 0x39, 0x28}};
    }
    ...
    namespace DOM::StrokeStyle {
         ...
         */
        class IRaggedStrokeStyle : public FCM::VirtualClass<IID_IRAGGED_STROKE_STYLE> {
        public:
            /**
