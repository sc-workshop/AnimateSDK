...
namespace Animate {
    ...
    namespace DOM {
         ...
         */
        FCM::ConstFCMIID IID_ILAYER = {0x926cb1e2, 0xce8a, 0x40ec, {0x84, 0xdc, 0x80, 0x5e, 0x11, 0x70, 0x84, 0xbc}};
    }
    ...
    namespace DOM::Layer {
         ...
         */
        FCM::ConstFCMIID IID_ILAYER_FOLDER = {0x404d03b5, 0xb3a8, 0x4aa6, {0xb4, 0x96, 0x46, 0x69, 0x38, 0x4f, 0x36, 0x91}};
    }
    ...
    namespace DOM::Layer {
         ...
         */
        FCM::ConstFCMIID IID_ILAYER_NORMAL = {0x4254c006, 0x17ce, 0x497c, {0xa6, 0x2c, 0x4, 0xf5, 0xd6, 0x9c, 0x87, 0x5}};
    }
    ...
    namespace DOM::Layer {
         ...
         */
        FCM::ConstFCMIID IID_ILAYER_MASK = {0x55886e53, 0xcba5, 0x4708, {0xaf, 0xa7, 0x60, 0xc1, 0x39, 0x8, 0xf8, 0xe2}};
    }
    ...
    namespace DOM::Layer {
         ...
         */
        FCM::ConstFCMIID IID_ILAYER_GUIDE = {0xd34ce64, 0x23a2, 0x4ff0, {0xbf, 0xca, 0x36, 0x8e, 0xde, 0x7d, 0x41, 0x4c}};
    }
    ...
    namespace DOM {
         ...
         */
        class ILayer : public FCM::VirtualClass<IID_ILAYER> {
        public:
            /**
    ...
    namespace DOM::Layer {
         ...
         */
        class ILayerFolder : public FCM::VirtualClass<IID_ILAYER_FOLDER> {
        public:
            /**
    ...
    namespace DOM::Layer {
         ...
         */
        class ILayerNormal : public FCM::VirtualClass<IID_ILAYER_NORMAL> {
        public:
            /**
    ...
    namespace DOM::Layer {
         ...
         */
        class ILayerMask : public FCM::VirtualClass<IID_ILAYER_MASK> {
        public:
            /**
             * @brief  Returns the list of child layers.
             *
    ...
    namespace DOM::Layer {
         ...
         */
        class ILayerGuide : public FCM::VirtualClass<IID_ILAYER_GUIDE> {
        public:
            /**
             * @brief  Returns the list of child layers.
             *
