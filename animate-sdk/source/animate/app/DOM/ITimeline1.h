...
namespace Animate {
    ...
    namespace DOM {
         ...
         */
        FCM::ConstFCMIID IID_ITIMELINE1 = {0x3070bd72, 0x890b, 0x47c8, {0xaf, 0xbb, 0xed, 0x15, 0xad, 0x82, 0x4e, 0xdf}};
    }
    ...
    namespace DOM {
        ...
        public:
            /**
             * @brief  This function returns true if "Advanced layers" mode is enabled for this timeline else returns
             * false.
             *
