...
namespace Animate {
    ...
    namespace DOM {
         ...
         */
        FCM::ConstFCMIID IID_ICAMERA = {0xc4c1befd, 0x83eb, 0x46a5, {0xa9, 0x93, 0xa7, 0x93, 0x4, 0x84, 0xfd, 0x6c}};
    }
    ...
    namespace DOM {
         ...
         */
        class ICamera : public FCM::VirtualClass<IID_ICAMERA> {
        public:
            /**
             ...
             *
             */
            virtual FCM::Result _FCMCALL
            GetColorFilter(FCM::U_Int32 frameIndex, FCM::Float& brightness, FCM::Float& contrast, FCM::Float& saturation, FCM::Float& hue) = 0;
