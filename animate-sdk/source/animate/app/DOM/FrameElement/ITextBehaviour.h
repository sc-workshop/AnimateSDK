...
namespace Animate {
    ...
    namespace DOM::FrameElement {
         ...
         */
        FCM::ConstFCMIID IID_ITEXT_BEHAVIOUR = {0xcd4a280, 0x95e3, 0x4476, {0xa0, 0x64, 0x41, 0x98, 0x4a, 0x58, 0x94, 0x33}};
         ...
         */
        FCM::ConstFCMIID IID_ISTATIC_TEXT_BEHAVIOUR = {0x6327c2d6, 0xb763, 0x4ac9, {0x8f, 0xbd, 0xf4, 0xc2, 0x91, 0x34, 0xd1, 0x7c}};
         ...
         */
        FCM::ConstFCMIID IID_IMODIFIABLE_TEXT_BEHAVIOUR = {0x6499d11f, 0x6af1, 0x4403, {0xbd, 0xb1, 0x76, 0x2, 0x14, 0xf3, 0x9d, 0x95}};
         ...
         */
        FCM::ConstFCMIID IID_IDYNAMIC_TEXT_BEHAVIOUR = {0x94655a95, 0x990b, 0x4540, {0x91, 0x5b, 0x70, 0x52, 0x93, 0x32, 0x31, 0xf8}};
         ...
         */
        FCM::ConstFCMIID IID_IINPUT_TEXT_BEHAVIOUR = {0x9d1e6460, 0x990f, 0x4d81, {0xbb, 0x24, 0x8d, 0x91, 0x59, 0xcd, 0x96, 0xf9}};
    }
    ...
    namespace DOM::FrameElement {
         ...
         */
        class ITextBehaviour : public FCM::VirtualClass<IID_ITEXT_BEHAVIOUR> {
        public:
            /**
         ...
         *        present on the stage.
         */
        class IStaticTextBehaviour : public FCM::VirtualClass<IID_ISTATIC_TEXT_BEHAVIOUR> {
        public:
            /**
         ...
         */
        class IModifiableTextBehaviour : public FCM::VirtualClass<IID_IMODIFIABLE_TEXT_BEHAVIOUR> {
        public:
            /**
         ...
         *        present on the stage.
         */
        class IDynamicTextBehaviour : public FCM::VirtualClass<IID_IDYNAMIC_TEXT_BEHAVIOUR> {};
         ...
         *        present on the stage.
         */
        class IInputTextBehaviour : public FCM::VirtualClass<IID_IINPUT_TEXT_BEHAVIOUR> {
        public:
            /**
