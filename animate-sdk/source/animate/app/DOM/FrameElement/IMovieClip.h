...
namespace Animate {
    ...
    namespace DOM::FrameElement {
         ...
         */
        FCM::ConstFCMIID IID_IMOVIE_CLIP_INSTANCE = {0x80f09ff2, 0x2894, 0x4d72, {0xbc, 0xe7, 0x0, 0xe7, 0xef, 0xeb, 0x68, 0x3f}};
    }
    ...
    namespace DOM::FrameElement {
         ...
         */
        class IMovieClip : public FCM::VirtualClass<IID_IMOVIE_CLIP_INSTANCE> {
        public:
            /**
