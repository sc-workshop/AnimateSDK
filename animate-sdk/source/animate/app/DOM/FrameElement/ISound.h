...
namespace Animate {
    ...
    namespace DOM::FrameElement {
         ...
         */
        enum class SoundRepeatMode {
            /** Sound is looped infinitely */
            SOUND_REPEAT_INFINITE = 0,
    ...
    namespace DOM::FrameElement {
         ...
         */
        FCM::ConstFCMIID IID_ISOUND_ELEMENT = {0xef9dff11, 0x1b84, 0x41ba, {0xac, 0x7f, 0xc2, 0x56, 0xf, 0x69, 0x2f, 0x30}};
    }
    ...
    namespace DOM::FrameElement {
         ...
         */
        class ISound : public FCM::VirtualClass<IID_ISOUND_ELEMENT> {
        public:
            /**
