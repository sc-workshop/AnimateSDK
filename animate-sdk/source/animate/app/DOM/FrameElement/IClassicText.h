...
namespace Animate {
    ...
    namespace DOM::FrameElement {
         ...
         */
        FCM::ConstFCMIID IID_ICLASSIC_TEXT_ELEMENT = {0x5c41008c, 0x3fbd, 0x496d, {0xa3, 0xd1, 0xee, 0x75, 0x2d, 0x9, 0x1d, 0xda}};
    }
    ...
    namespace DOM::FrameElement {
         ...
         */
        class IClassicText : public FCM::VirtualClass<IID_ICLASSIC_TEXT_ELEMENT> {
        public:
            /**
