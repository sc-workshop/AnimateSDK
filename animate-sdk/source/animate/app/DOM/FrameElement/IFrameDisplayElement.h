...
namespace Animate {
    ...
    namespace DOM::FrameElement {
         ...
         */
        FCM::ConstFCMIID IID_IFRAME_DISPLAY_ELEMENT = {0x800f6ff6, 0x59c5, 0x4fe3, {0xab, 0xbb, 0xce, 0xe2, 0x62, 0x61, 0xa6, 0xb8}};
    }
    ...
    namespace DOM::FrameElement {
        ...
        class IFrameDisplayElement : public FCM::VirtualClass<IID_IFRAME_DISPLAY_ELEMENT> {
        public:
            /**
