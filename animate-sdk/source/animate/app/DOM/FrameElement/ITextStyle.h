...
namespace Animate {
    ...
    namespace DOM::FrameElement {
         ...
         */
        enum class BaseLineShiftStyle {
            /** Normal base line shift style */
            BASE_LINE_SHIFT_STYLE_NORMAL = 0,
    ...
    namespace DOM::FrameElement {
         ...
         */
        FCM::ConstFCMIID IID_ITEXT_STYLE = {0xc8538de2, 0x7d59, 0x4e0b, {0xb1, 0xed, 0xef, 0x4a, 0x5c, 0x55, 0xcc, 0x9}};

        /**
         * @brief Defines the 'regular' text style.
         */
        const FCM::CStringRep8 REGULAR_STYLE_STR = "RegularStyle";

        /**
         * @brief Defines the 'italic' text style.
         */
        const FCM::CStringRep8 ITALIC_STYLE_STR = "ItalicStyle";

        /**
         * @brief Defines the 'bold' text style.
         */
        const FCM::CStringRep8 BOLD_STYLE_STR = "BoldStyle";

        /**
         * @brief Defines the 'bold-italic' text style.
         */
        const FCM::CStringRep8 BOLD_ITALIC_STYLE_STR = "BoldItalicStyle";
    }
    ...
    namespace DOM::FrameElement {
         ...
         */
        class ITextStyle : public FCM::VirtualClass<IID_ITEXT_STYLE> {
        public:
            /**
             ...
             * @return On success, FCM_SUCCESS is returned, else an error code is returned.
             */
            virtual FCM::Result _FCMCALL GetFontColor(DOM::Utils::COLOR& fontColor) = 0;
             ...
             * @return On success, FCM_SUCCESS is returned, else an error code is returned.
             */
            virtual FCM::Result _FCMCALL GetBaseLineShiftStyle(BaseLineShiftStyle& baseLineShiftStyle) = 0;
