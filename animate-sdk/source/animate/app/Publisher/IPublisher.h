...
namespace Animate::Publisher {
     ...
     */
    FCM::ConstFCMIID ID_IPublisher = {0x3acf3427, 0x4fd, 0x44ef, {0x9f, 0xba, 0x3e, 0xbb, 0x62, 0xf0, 0x44, 0xa2}};
}
/* -------------------------------------------------- Class Declaration */
...
namespace Animate::Publisher {
    ...
    public:
         ...
         */
        virtual FCM::Result _FCMCALL Publish(DOM::PIFLADocument pFlaDocument,
